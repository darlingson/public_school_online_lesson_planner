          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className="border rounded p-2 focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              {lessonPlan.objectives.map((objective, index) => (
                <input
                  ...
                  className="border rounded p-2 mb-2 focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
              ))}
              <button
                type="button"
                onClick={() => addArrayItem("objectives")}
                className="bg-orange-500 text-white py-1 px-3 rounded hover:bg-orange-600 mt-2"
              >
                Add Objective
              </button>
            </div>
            <div className="flex flex-col">
              ...
              {lessonPlan.materials.map((material, index) => (
                <input
                  key={index}
                  value={material}
                  onChange={(e) => handleArrayChange(e, index, "materials")}
                  className="border rounded p-2 mb-2 focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
              ))}
              <button
