    ...
    <Navbar pathname="/lesson-plans"/>
      ...
      >
        ...
        <input
          ...
          className="w-full p-2 pl-10 text-sm text-gray-700 border border-gray-200 rounded"
        />
        <br />
        <br />
        ...
        <input
          ...
          onChange={(e) => handleChange(e, null, "class_name")}
          className="w-full p-2 pl-10 text-sm text-gray-700 border border-gray-200 rounded"
        />
        <br />
        <br />
        ...
        {formData.materials.map((material, index) => (
          <div key={index} className="flex mb-2">
            <input
              type="text"
              value={material}
              onChange={(e) => handleChange(e, index, "materials")}
              className="w-full p-2 pl-10 text-sm text-gray-700 border border-gray-200 rounded"
            />
          </div>
        ))}
        <button
          type="button"
          onClick={() => handleAddInput("materials")}
          className="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded"
        >
          Add Material
        </button>
        ...
        <input
          ...
          onChange={(e) => handleChange(e, null, "timing")}
          className="w-full p-2 pl-10 text-sm text-gray-700 border border-gray-200 rounded"
        />
        <br />
        <br />
